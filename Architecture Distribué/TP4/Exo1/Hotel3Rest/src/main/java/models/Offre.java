...
public class Offre{
    ...
    public Offre(int id_offre,String nom,int numero_chambre, int nb_lits, ArrayList<Disponibiliter> disponible , float prix , String adresseimage) throws IOException{
		this.nom = nom;
		...
		this.prix = prix;
        File fichier = new File (adresseimage);
