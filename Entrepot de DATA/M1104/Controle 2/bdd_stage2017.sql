...
CREATE SCHEMA CTRL2_stage;
  
set search_path = CTRL2_stage ;
...
CREATE TABLE Societe (
    ...
    nom_Soc VARCHAR(25) NOT NULL UNIQUE,
    raisons VARCHAR(20),
    adresse VARCHAR(60)
);
...
CREATE TABLE Personnel (
    ...
    nom_pers VARCHAR(25) NOT NULL,
    prenom_pers VARCHAR(20),
...
INSERT INTO Societe VALUES (8, 'Microware', 'SARL', 'Aix_en_Pce');
INSERT INTO Societe VALUES (13, 'EdF', 'SEM',  'Marseille');
INSERT INTO Societe VALUES (21, 'TOTAL', 'SA', 'Fos_sur_Mer');
INSERT INTO Societe VALUES (34, 'Almacom', 'SARL', 'Aubagne');
